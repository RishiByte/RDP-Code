...
function App() {
  return (
    <div className="h-screen w-screen flex bg-slate-900 text-slate-300 overflow-hidden">
      {/* Activity Bar Placeholder */}
      <div className="w-12 bg-slate-950 flex flex-col items-center py-2 gap-4 border-r border-slate-800">
